...
function Movies() {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `https://api.themoviedb.org/3/trending/movie/day?api_key=013aa433cc1f91b4c9344d184bdb751f&language=en-US&page=${page}`
      )
      .then((response) => {
  ...
  return (
    ...
    {loading ? (
      ...
      <>
        <div className="flex justify-evenly flex-wrap gap-8 py-8 px-8">
          {movies.map((movieObj) => (
